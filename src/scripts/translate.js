...
const translations = {
    'de': {
        ...
        'about-description': 'Meine Interessen umfassen Programmierung, Gaming, das Erstellen von Inhalten für meine Community und ich gehe zur Feuerwehr.\nDiese Webseite dient als Plattform, um meine Projekte zu präsentieren und ich wollte meiner Community etwas zurückgeben.\nauch wenn es nur was kleines ist.',
        'about-thanks-title': 'Danke fürs Besuchen!',
        'about-thanks-text': 'Ich schätze jeden einzelnen Besucher meiner Webseite.\nVielen Dank für eure Unterstützung und euer Interesse an meinen Projekten!',
        ...
        'projects-description': 'Hier ist eine Übersicht meiner aktuellen und vergangenen Projekte:',
        ...
        'dashboard-description': 'Administrationsbereich für erweiterte Funktionen.',
        'faq-title': 'Häufig gestellte Fragen (FAQ)',
        'faq-description': 'Antworten auf die am häufigsten gestellten Fragen.',
        'faq-q1': 'Frage 1: Wie kann ich mich registrieren?',
        'faq-a1': 'Antwort: Du klickst auf die Schaltfläche "Registrieren" oben rechts auf der Seite und füllst das Formular aus.',
        'faq-q2': 'Frage 2: Wie kann ich den Night Mode aktivieren?',
        'faq-a2': 'Antwort: Du klickst auf die Schaltfläche "Night Mode" in der Navigationsleiste, um zwischen dem normalen Modus und dem Night Mode zu wechseln.',
        ...
        'faq-q4': 'Frage 4: Wird es eine Custom Firmware für den 3DS geben?',
        ...
        'failed-item-1': 'Ein Musik Bot für Discord',
        'failed-item-2': 'Eine eigene Custom Firmware für den Nintendo 3DS',
        'failed-item-3': 'Ein Plugin für Minecraft',
        'newly-started-title': 'Neu angefangende Projekte:',
        'newly-started-item-1': 'Eine Webseite für meine Community',
        'newly-started-item-2': 'Ein Discord Bot für den MFFA Server',
        'newly-started-item-3': 'Unsere neuen Discord Bots erkäntlich am Wulfy',
...
function translatePage(language) {
    ...
    elements.forEach(element => {
        ...
        if (translations[language][key]) {
            // Direkte Text-Ersetzung ohne Layout-Änderung
